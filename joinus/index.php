...
?>
				<div class="block why">
					...
					<div class="reason">
						<img src="/img/bluereason.png" alt=""><!--
						--><p>Чтобы увидеть новые перспективы</p>
					</div>
					<div class="reason">
						<img src="/img/greenreason.png" alt=""><!--
						--><p>Чтобы заложить прочные традиции</p>
					</div>
					<br>
					<div class="reason">
						<img src="/img/yellowreason.png" alt=""><!--
						--><p>Чтобы предоставлять больше возможностей</p>
					</div>
					<div class="reason">
						<img src="/img/pinkreason.png" alt=""><!--
				...
				<div class="block open">
					...
					<div>
						<a href="javascript:void(null);">
							<img src="/img/location_local.png" alt="">
						</a>
						<a href="javascript:void(null);">

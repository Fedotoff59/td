...
?>
				<div class="block programm">
					...
					<div>
						<ul>
							<li class="label"><a href=""><p>Справка</p></a></li><!--
							--><li class="label"><a href=""><p>Положение</p></a></li><!--
							--><li class="label"><a href=""><p>Презентация</p></a></li><!--
				...
				<div class="block lampa">
					...
					<img src="<?=SITE_SERVER_NAME?>/img/lampa.png" alt="" class="banner_img">
					<p>I Международный Кинофестиваль социально ориентированных короткометражных фильмов, видеороликов и социальной рекламы «ЛАМПА» пройдет под темой «Человек, поступок, выбор». К участию в фестивале приглашаются образовательные </p>
					<div>
						<ul>
							<li class="label"><a href=""><p>Справка</p></a></li><!--
							--><li class="label"><a href=""><p>Положение</p></a></li><!--
